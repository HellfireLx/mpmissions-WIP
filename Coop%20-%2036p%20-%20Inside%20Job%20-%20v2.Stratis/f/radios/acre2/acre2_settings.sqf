...
f_radios_settings_acre2_longRange = ["co", "dc", "mmgag","hmgag","matag","hatag", "mcc", "tr", "mtrag","msamag", "vc", "pp", "pcc"];
...
f_radios_settings_acre2_extraRadios = ["pp", "pcc", "vc"];
...
f_radios_settings_acre2_groups_blufor = ["Plt Net 1","Plt Net 2","Plt Net 3","Convoy","Air","Support","Mechanised","Tank"];
f_radios_settings_acre2_groups_opfor = ["Plt Net 1","Plt Net 2","Plt Net 3","Convoy","Air","Support","Mechanised","Tank"];
f_radios_settings_acre2_groups_indfor = ["Plt Net 1","Plt Net 2","Plt Net 3","Convoy","Air","Support","Mechanised","Tank"];
