...
// Markers seen by players in NATO slots.
	...
	case "blu_f":
	{
		...
		["GrpNATO_MCC", 0, "GM", "ColorYellow"] spawn f_fnc_localGroupMarker;
		["GrpNATO_T1", 0, "T1", "ColorYellow"] spawn f_fnc_localGroupMarker;
		["GrpNATO_T2", 0, "T2", "ColorYellow"] spawn f_fnc_localGroupMarker;
		["GrpNATO_T3", 0, "T3", "ColorYellow"] spawn f_fnc_localGroupMarker;
		["GrpNATO_T4", 0, "T4", "ColorYellow"] spawn f_fnc_localGroupMarker;
		...
		["GrpNATO_ENG1",  6, "ENG1", "ColorOrange"] spawn f_fnc_localGroupMarker;
 		...
 		["GrpNATO_IFV1",  7, "Flash 1", "ColorRed"] spawn f_fnc_localGroupMarker;
		["GrpNATO_IFV2",  7, "Flash 2", "ColorRed"] spawn f_fnc_localGroupMarker;
		["GrpNATO_IFV3",  7, "Flash 3", "ColorBlue"] spawn f_fnc_localGroupMarker;
		["GrpNATO_IFV4",  7, "Flash 4", "ColorBlue"] spawn f_fnc_localGroupMarker;
		["GrpNATO_IFV5",  7, "Flash 5", "ColorGreen"] spawn f_fnc_localGroupMarker;
		["GrpNATO_IFV6",  7, "Flash 6", "ColorGreen"] spawn f_fnc_localGroupMarker;
		["GrpNATO_IFV7",  7, "Dagger 1", "ColorOrange"] spawn f_fnc_localGroupMarker;
		["GrpNATO_IFV8",  7, "Dagger 2", "ColorOrange"] spawn f_fnc_localGroupMarker;

 		["GrpNATO_TNK1",  8, "Thunder", "ColorOrange"] spawn f_fnc_localGroupMarker;

		["GrpNATO_TH1",  9, "Nightbird 1", "ColorRed"] spawn f_fnc_localGroupMarker;
 		["GrpNATO_TH2",  9, "Nightbird 2", "ColorBlue"] spawn f_fnc_localGroupMarker;
 		["GrpNATO_TH3",  9, "Nightbird 3", "ColorGreen"] spawn f_fnc_localGroupMarker;
 		["GrpNATO_TH4",  9, "Falcon 1", "ColorRed"] spawn f_fnc_localGroupMarker;
 		["GrpNATO_TH5",  9, "Falcon 2", "ColorBlue"] spawn f_fnc_localGroupMarker;
  		["GrpNATO_TH6",  9, "Falcon 3", "ColorGreen"] spawn f_fnc_localGroupMarker;
   		["GrpNATO_TH7",  9, "Hawk 1", "ColorOrange"] spawn f_fnc_localGroupMarker;
		["GrpNATO_TH8",  9, "Hawk 2", "ColorOrange"] spawn f_fnc_localGroupMarker;

		["GrpNATO_AH1",  9, "Reaper", "ColorOrange"] spawn f_fnc_localGroupMarker;

		["UnitNATO_CO_M", 0, "", "ColorYellow"] spawn f_fnc_localSpecialistMarker;
		["UnitNATO_DC_M", 0, "", "ColorYellow"] spawn f_fnc_localSpecialistMarker;
...
// Markers seen by players in CSAT slots.
	...
	case "opf_f":
	{
		...
		["GrpCSAT_ENG1",  6, "ENG1", "ColorOrange"] spawn f_fnc_localGroupMarker;
 		...
 		["GrpCSAT_IFV1",  7, "Baldur 1", "ColorRed"] spawn f_fnc_localGroupMarker;
		["GrpCSAT_IFV2",  7, "Baldur 2", "ColorRed"] spawn f_fnc_localGroupMarker;
 		["GrpCSAT_IFV3",  7, "Baldur 3", "ColorBlue"] spawn f_fnc_localGroupMarker;
		["GrpCSAT_IFV4",  7, "Baldur 4", "ColorBlue"] spawn f_fnc_localGroupMarker;
 		["GrpCSAT_IFV5",  7, "Baldur 5", "ColorGreen"] spawn f_fnc_localGroupMarker;
		["GrpCSAT_IFV6",  7, "Baldur 6", "ColorGreen"] spawn f_fnc_localGroupMarker;
 		["GrpCSAT_IFV7",  7, "Vitharr 1", "ColorOrange"] spawn f_fnc_localGroupMarker;
		["GrpCSAT_IFV8",  7, "Vitharr 2", "ColorOrange"] spawn f_fnc_localGroupMarker;

 		["GrpCSAT_TNK1",  8, "Odin", "ColorOrange"] spawn f_fnc_localGroupMarker;

		["GrpCSAT_TH1",  9, "Loki 1", "ColorRed"] spawn f_fnc_localGroupMarker;
		["GrpCSAT_TH2",  9, "Loki 2", "ColorBlue"] spawn f_fnc_localGroupMarker;
		["GrpCSAT_TH3",  9, "Loki 3", "ColorGreen"] spawn f_fnc_localGroupMarker;
		["GrpCSAT_TH4",  9, "Thor 1", "ColorRed"] spawn f_fnc_localGroupMarker;
		["GrpCSAT_TH5",  9, "Thor 2", "ColorBlue"] spawn f_fnc_localGroupMarker;
		["GrpCSAT_TH6",  9, "Thor 3", "ColorGreen"] spawn f_fnc_localGroupMarker;
		["GrpCSAT_TH7",  9, "Heimdallr 1", "ColorOrange"] spawn f_fnc_localGroupMarker;
		["GrpCSAT_TH8",  9, "Heimdallr 2", "ColorOrange"] spawn f_fnc_localGroupMarker;

		["GrpCSAT_AH1",  9, "Ragnarök", "ColorOrange"] spawn f_fnc_localGroupMarker;

		["UnitCSAT_CO_M", 0, "", "ColorYellow"] spawn f_fnc_localSpecialistMarker;
		["UnitCSAT_DC_M", 0, "", "ColorYellow"] spawn f_fnc_localSpecialistMarker;
...
// Markers seen by players in AAF slots.
	...
	case "ind_f":
	{
		...
		["GrpAAF_ENG1",  6, "ENG1", "ColorOrange"] spawn f_fnc_localGroupMarker;
 		...
 		["GrpAAF_IFV1",  7, "Atlas 1", "ColorRed"] spawn f_fnc_localGroupMarker;
		["GrpAAF_IFV2",  7, "Atlas 2", "ColorRed"] spawn f_fnc_localGroupMarker;
 		["GrpAAF_IFV3",  7, "Atlas 3", "ColorBlue"] spawn f_fnc_localGroupMarker;
		["GrpAAF_IFV4",  7, "Atlas 4", "ColorBlue"] spawn f_fnc_localGroupMarker;
 		["GrpAAF_IFV5",  7, "Atlas 5", "ColorGreen"] spawn f_fnc_localGroupMarker;
		["GrpAAF_IFV6",  7, "Atlas 6", "ColorGreen"] spawn f_fnc_localGroupMarker;
 		["GrpAAF_IFV7",  7, "Artemis 1", "ColorOrange"] spawn f_fnc_localGroupMarker;
		["GrpAAF_IFV8",  7, "Artemis 2", "ColorOrange"] spawn f_fnc_localGroupMarker;

 		["GrpAAF_TNK1",  8, "Ares", "ColorOrange"] spawn f_fnc_localGroupMarker;

		["GrpAAF_TH1",  9, "Hermes 1", "ColorRed"] spawn f_fnc_localGroupMarker;
		["GrpAAF_TH2",  9, "Hermes 2", "ColorBlue"] spawn f_fnc_localGroupMarker;
		["GrpAAF_TH3",  9, "Hermes 3", "ColorGreen"] spawn f_fnc_localGroupMarker;
		["GrpAAF_TH4",  9, "Orion", "ColorOrange"] spawn f_fnc_localGroupMarker;

		["GrpAAF_AH1",  9, "Hades", "ColorOrange"] spawn f_fnc_localGroupMarker;

		["UnitAAF_CO_M", 0, "", "ColorYellow"] spawn f_fnc_localSpecialistMarker;
		["UnitAAF_DC_M", 0, "", "ColorYellow"] spawn f_fnc_localSpecialistMarker;
...
// Markers seen by players in BLUFOR-FIA slots.
	...
	case "blu_g_f":
	{
		...
		["UnitFIA_DC_M", 0, "", "ColorYellow"] spawn f_fnc_localSpecialistMarker;
...
// Markers seen by players in OPFOR-FIA slots.
	...
	case "opf_g_f":
	{
		...
		["UnitOFIA_DC_M", 0, "", "ColorYellow"] spawn f_fnc_localSpecialistMarker;
...
// Markers seen by players in INDEPENDENT-FIA slots.
	...
	case "ind_g_f":
	{
		...
		["UnitIFIA_DC_M", 0, "", "ColorYellow"] spawn f_fnc_localSpecialistMarker;
